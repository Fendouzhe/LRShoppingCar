...
protocol LRShoppingCartCellDelegate: NSObjectProtocol {
...
class LRShoppingCartCell: UITableViewCell {
    ...
    /// 代理属性
    weak var delegate: LRShoppingCartCellDelegate?
    ...
    */
    ...
    // 老价格标签
    private lazy var oldPriceLabel: LROldPriceLabel = {
        let oldPriceLabel = LROldPriceLabel()
